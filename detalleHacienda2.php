...
<form method="post">
 <center>
  <!--PONER IMAGEN DE FONDO DEL CAMPO Y PONERLE UN COLOR DE FONDO A LAS TABLAS
      LO PUSE ASI PARA QUE SE ENTIENDA LA IDEA YA SE QUE ESTA BIEN FEITO
    TAMBIEN CAMBIE LAS CAJAS DE TEXTO POR LOS DATETIMEPICKERS Y FUNCIONAN BIEN-->
...
<?php
   ...
   {  // Conecta a la base de datos
    ...
    //{  //cadena que agrega el regsitro osea la fila a la tabla CampañaHacienda
       ...
       echo "<center> El detalle fue dado de alta con exito </center>";
    //}
    //else 
   // {
