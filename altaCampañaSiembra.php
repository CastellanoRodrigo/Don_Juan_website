...
<?php
   ...
   {  // Conecta a la base de datos
     ...
     $sql="select  * from campañasiembra  where Id_CampañaSiembra= $idcamp";
     ...
     {  //cadena que agrega el regsitro osea la fila a la tabla CampañaHacienda
        $cad = "INSERT INTO campañasiembra(Id_CampañaSiembra, Id_Parcela, NombreCampaña, Id_DetalleSiembra, Estado) VALUES ('$idcamp','$parcela','$nombre','$iddetalle','$estado')";
